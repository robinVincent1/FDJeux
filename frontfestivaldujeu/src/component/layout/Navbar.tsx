...
const pages = [{title:'Accueil',href:'/accueil'}, {title: "festival", href: "/festival"}, {title:'Planning General ',href:'/planning_general'},{title:'News',href:'/news'},{title:'Planning Personnel', href:'/planning_perso'}, {title: "Forum", href: "/forum"}, {title:"Infos", href:"/creerinfos"}, {title:"Hebergement", href:"/hebergement"}];
