...
export const PageRepas = () => {
  ...
  return (
    <div>
      <h1 className="p-8 flex justify-center font-bold text-xl"> Repas</h1>
      <div className="flex justify-center bg-[#0E8DDF]">
        <div className="p-8">
          <h1 className="font-bold flex justify-center p-2 text-white">Samedi Midi</h1>
          {repasSM.etat == 1 ? (
                ...
                <div>
                  {repasSM.etat == 2 ? (
                    <div className="italic justify-center flex text-white">
                      ...
                      <strong className="ml-2 text-[red]"><NotificationsActiveIcon /></strong>
                    </div>
                  ) : (
                    <div className="italic justify-center flex text-white">
                      Repas déjà pris !
        ...
        <div className="p-8">
          <h1 className="font-bold flex justify-center p-2 text-white">Samedi Soir</h1>
          {repasSS.etat == 1 ? (
            <div className="flex justify-center">
              <Button
                onClick={() => {
        ...
        <div className="p-8">
          <h1 className="font-bold flex justify-center p-2 text-white">Dimanche Midi</h1>
          {repasDM.etat == 1 ? (
            <div className="flex justify-center">
              <Button
                onClick={() => {
      ...
      <div className="grid grid-cols-3 pt-8">
        ...
        <div>
          <h2 className="font-bold flex justify-center text-lg">Repas Samedi Midi</h2>
          {listeRepasDemandeSM.length > 0 && listeRepasDemandeSM.map((d) => (
        ...
        <div>
          <h2 className="font-bold flex justify-center text-lg">Repas Samedi Soir</h2>
          {listeRepasDemandeSS.length > 0 && listeRepasDemandeSS.map((d) => (
            <div className="p-4  flex">
              <div>
                <p className="font-bold">
                  {d.User.firstName} {d.User.lastName}
        ...
        <div>
          <h2 className="font-bold flex justify-center text-lg">Repas Dimanche Midi</h2>
          {listeRepasDemandeDM.length > 0 && listeRepasDemandeDM.map((d) => (
            <div className="p-4  flex">
              <div>
                <p className="font-bold">
                  {d.User.firstName} {d.User.lastName}
